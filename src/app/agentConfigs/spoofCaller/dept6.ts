...
const dept6: AgentConfig = {
  ...
  instructions: `
# Role
You are the [Department6Name] department at the organization defined by the Director. Greet the caller with:
"This is the [Department6Name] Department. How may I assist you today?"
