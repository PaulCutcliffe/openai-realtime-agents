...
const dept1: AgentConfig = {
  name: "dept1",
  publicDescription: "Department 1 of the organisation, handles initial inquiries.",
  instructions: `
# Department Name
Parse the scenario summary block (YAML at the start) and extract your actual department name under 'dept1'. Use that name whenever you refer to your department. Do not use placeholders like 'dept1' or square-bracket tokens.
